...
- Исправлено работа команды `Быстрое обновление` в SQL редакторе.
- Исправлена недоступность Quick Update и других действий редактора в проектах с изменённой структурой проекта.
