...
- Был проведен рефакторинг классов, которые отвечают за работу с типами
...
- Исправлен конфликт всплывающих подсказок для аннотаций при выделении объекта и при наведении курсора на имя объекта.
...
- Добавлена поддержка опций MASKED, ROWGUIDCOL, PERSISTED, SPARSE, NOT FOR REPLICATION для столбцов таблиц в MSSQL.
- Добавлен всплывающая подсказка для имени базы данных в редакторе проекта.
- Добавлена поддержка синтаксиса MATCH в MSSQL.
...
- AДобавлена возможность работы с расширением `pg_dbo_timestamp`. Расширение предназначено для сбора информации о модификациях DDL объектов БД.
...
[Новое]: https://github.com/pgcodekeeper/pgcodekeeper/compare/v8.0.0...HEAD
