...
- Добавлена настройка для формирования скрипта миграции по актуальной версии базы данных (на текущий момент нет изменений синтаксиса, они появятся позднее). По умолчанию используется синтаксис, характерный для минимальной поддерживаемой версии.
...
[Новое]: https://github.com/pgcodekeeper/pgcodekeeper/compare/v14.1.1...HEAD
