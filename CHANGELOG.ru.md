...
- Добавлена возможность изменять состояние клонированных родительских триггеров в партиционных таблицах.

### Изменено

- Улучшена работа функции автодополнения кода.
- Исправлены названия опций в `Мастере сравнения`.

### Исправлено

- Исправлено игнорирование длины столбца с типом nchar в исходной БД в MS SQL.
