...
- Добавлен тултип имени базы данных в редакторе проекта.
...
- Исправлена ошибка удаления индекса на основной таблице, возникающая при удалении его партиции.
- Исправлена ошибка при чтении дефолтного значения аргумента с параметром VARIADIC в сигнатуре функции.
