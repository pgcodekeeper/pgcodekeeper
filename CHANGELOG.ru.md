...
- Обновлена отправка анонимных данных с Google Universe до Google Analytics 4.
- Убран предустановленный лимит при запросе SELECT, от 100к строк подвисает ui.
