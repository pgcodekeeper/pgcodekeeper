...
public class PgProjectLoaderTest {
    ...
    InterruptedException, URISyntaxException {
        try(TempDir tempDir = new TempDir("ignore-schemas-test-project")){
            ...
            PgDatabase dbDump = ApgdiffTestUtils.loadTestDump(
                    ApgdiffTestUtils.RESOURCE_DUMP, ApgdiffTestUtils.class, args);

            new ModelExporter(dir, dbDump, ApgdiffConsts.UTF_8).exportFull();
