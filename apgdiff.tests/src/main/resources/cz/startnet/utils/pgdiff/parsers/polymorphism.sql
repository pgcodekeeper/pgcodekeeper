...
create function dfunc(variadic a int[]) returns int as
...
create or replace function dfunc(variadic a int[] /*default array[]::int[]*/) returns int as
$$ select array_upper($1, 1) $$ language sql;
...
create or replace function dfunc(variadic a int[]) returns int as
$$ select array_upper($1, 1) $$ language sql;
