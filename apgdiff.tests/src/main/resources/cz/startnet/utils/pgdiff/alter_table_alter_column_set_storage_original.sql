...
ALTER TABLE ONLY testtable ALTER COLUMN field1 SET STORAGE MAIN;
ALTER TABLE ONLY testtable ALTER COLUMN field2 SET STORAGE PLAIN;
ALTER TABLE ONLY testtable ALTER COLUMN field3 SET STORAGE EXTERNAL;
