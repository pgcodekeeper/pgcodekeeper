...
CREATE COLLATION public.test_collation5 ( LOCALE = ''ru_RU.utf8'', PROVIDER = ''icu'', VERSION = ''153.14.36.8'', DETERMINISTIC = FALSE);
...
DROP COLLATION public.test_collation18;
...
CREATE COLLATION public.test_collation8 ( LOCALE = ''ru_RU.utf8'', PROVIDER = ''icu'', VERSION = ''153.14.36.8'', DETERMINISTIC = FALSE);

CREATE COLLATION public.test_collation18 ( LC_COLLATE = ''ru_RU.utf8'',  LC_CTYPE = ''ru_RU.utf8'', PROVIDER = ''icu'', VERSION = ''153.14.36.8'');
...
CREATE COLLATION public.test_collation16 ( LC_COLLATE = ''sv_SE.utf8'',  LC_CTYPE = ''sv_SE.utf8'', PROVIDER = ''icu'', VERSION = ''153.14.36.8'');
