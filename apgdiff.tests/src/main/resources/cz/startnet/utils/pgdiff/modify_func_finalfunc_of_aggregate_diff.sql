...
-- DEPCY: This AGGREGATE depends on the FUNCTION: public.mode_bool_final(integer[], boolean, integer, text)

DROP AGGREGATE public.mode11_params(boolean, integer, text ORDER BY boolean, text);

DROP FUNCTION public.mode_bool_final(integer[], boolean, integer, text);
