...
-- DEPCY: This FTS_CONFIGURATION depends on the FTS_DICTIONARY: public.first_dictionary

DROP TEXT SEARCH CONFIGURATION public.first_configuration;

DROP TEXT SEARCH DICTIONARY public.first_dictionary;

-- DEPCY: This FTS_TEMPLATE is a dependency of FTS_CONFIGURATION: public.first_configuration
