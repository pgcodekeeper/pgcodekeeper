...
ALTER TABLE ONLY testtable ALTER COLUMN field2 SET (n_distinct=3.0, n_distinct_inherited=2.0);
ALTER TABLE ONLY testtable ALTER COLUMN field3 SET (n_distinct=-1.0);
ALTER TABLE ONLY testtable ALTER COLUMN field4 SET (n_distinct=3.0, n_distinct_inherited=-0.5);
