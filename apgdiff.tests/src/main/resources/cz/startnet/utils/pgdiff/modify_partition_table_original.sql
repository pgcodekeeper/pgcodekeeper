...
--
-- Name: cities_hi; Type: TABLE; Schema: public; Owner: galiev_mr
--

CREATE TABLE cities_hi PARTITION OF cities
FOR VALUES IN ('h', 'i');


ALTER TABLE cities_hi OWNER TO galiev_mr;
...
FOR VALUES IN ('m', 'z');
ALTER TABLE ONLY cities_mz ALTER COLUMN c2 SET NOT NULL;
...
ALTER TABLE ONLY ftable SET WITH OIDS;
