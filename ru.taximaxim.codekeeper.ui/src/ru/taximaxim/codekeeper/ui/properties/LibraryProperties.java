...
public class LibraryProperties extends PropertyPage {
    ...
    private LibrariesListEditor editor;
    ...
    protected Control createContents(Composite parent) {
        ...
        editor = new LibrariesListEditor(area);
    ...
    private class LibrariesListEditor extends PrefListEditor<Library> {

        private String action;

        public LibrariesListEditor(Composite parent) {
            super(parent);
        ...
        protected Library getNewObject(Library oldObject) {
            LibraryEditorDialog dialog = new LibraryEditorDialog(getShell(), oldObject, action,
