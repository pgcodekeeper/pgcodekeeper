...
public enum ObjectLevel {
    ...
    public static ObjectLevel getLevel(DatabaseType dbType, DbObjType objType) {
        ...
        case AGGREGATE, COLLATION, DOMAIN, FTS_CONFIGURATION, FTS_DICTIONARY, FTS_TEMPLATE, FTS_PARSER, OPERATOR ->
    ...
    public static List<DbObjType> getAllTypesForDbType(DatabaseType dbType, boolean addAllTypes) {
        ...
        types.addAll(getTypes(dbType, addAllTypes, ObjectLevel.SCHEMA, ObjectLevel.CONTAINER, ObjectLevel.SUB_ELEMENT));
