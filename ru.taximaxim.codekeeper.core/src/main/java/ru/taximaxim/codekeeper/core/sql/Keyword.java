 ...
 *******************************************************************************/
package ru.taximaxim.codekeeper.core.sql;

import static ru.taximaxim.codekeeper.core.sql.Keyword.KeywordCategory.COL_NAME_KEYWORD;
import static ru.taximaxim.codekeeper.core.sql.Keyword.KeywordCategory.RESERVED_KEYWORD;
import static ru.taximaxim.codekeeper.core.sql.Keyword.KeywordCategory.TYPE_FUNC_NAME_KEYWORD;
import static ru.taximaxim.codekeeper.core.sql.Keyword.KeywordCategory.UNRESERVED_KEYWORD;
import static ru.taximaxim.codekeeper.core.sql.Keyword.LabelCategory.AS_LABEL;
import static ru.taximaxim.codekeeper.core.sql.Keyword.LabelCategory.BARE_LABEL;
