...
-- DEPCY: This SCHEMA is a dependency of TYPE: test.tt1

CREATE SCHEMA collations;

-- DEPCY: This COLLATION is a dependency of TYPE: test.tt1
...
-- DEPCY: This COLLATION is a dependency of DOMAIN: test.d1

CREATE COLLATION collations.coll4 (LOCALE = 'fr_FR.utf8');

CREATE DOMAIN test.d1 AS TEXT COLLATE collations.coll4;

-- DEPCY: This COLLATION is a dependency of COLUMN: test.t1.c2
...
-- DEPCY: This COLLATION is a dependency of INDEX: test.i1

CREATE COLLATION collations.coll3 (LOCALE = 'fr_FR.utf8');

CREATE INDEX i1 ON test.t1 (c2 COLLATE collations.coll3);

-- DEPCY: This COLLATION is a dependency of VIEW: test.v1
