...
SET ANSI_NULLS ON
GO
--change GENERATED type SEQUENCE_NUMBER
CREATE TABLE [dbo].[test_gen1](
	[DepartmentNumber] [char] COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[ValidTo] [bigint] GENERATED ALWAYS AS SEQUENCE_NUMBER START HIDDEN NOT NULL,
	[ValidFrom] [bigint] GENERATED ALWAYS AS SEQUENCE_NUMBER END HIDDEN NULL
) ON [PRIMARY]
GO
...
CREATE TABLE [dbo].[test_seq_gen](
	[DepartmentNumber] [char] COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[seq_1] [bigint] NOT NULL,
	[seq_2] [bigint] NULL
) ON [PRIMARY]
GO

--remove GENERATED type SEQUENCE_NUMBER
...
CREATE TABLE [dbo].[test_tranxaction](
	[DepartmentNumber] [char] COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[tranx_1] [bigint] GENERATED ALWAYS AS TRANSACTION_ID START NOT NULL,
	[tranx_2] [bigint] GENERATED ALWAYS AS TRANSACTION_ID END NULL
) ON [PRIMARY]
GO
...
--change cols on GENERATED type ROW
...
--change GENERATED TRANSACTION_ID col to GENERATED ROW 
CREATE TABLE [dbo].[Department_new](
    [DepartmentNumber] [char] COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
    [DepartmentName] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
    [ManagerID] [int] NULL,
    [ParentDepartmentNumber] [char] COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
    [ValidFrom] [bigint] GENERATED ALWAYS AS TRANSACTION_ID START HIDDEN NOT NULL,
    [ValidTo] [bigint] GENERATED ALWAYS AS TRANSACTION_ID END HIDDEN NULL
) ON [PRIMARY]
GO

--change GENERATED ROW col to simple col
