...
--
-- Name: FUNCTION mode2(boolean); Type: ACL; Schema: public; Owner: shamsutdinov_lr
--

REVOKE ALL ON FUNCTION public.mode2(boolean) FROM PUBLIC;
...
--
-- Name: FUNCTION mode3(boolean); Type: ACL; Schema: public; Owner: shamsutdinov_lr
--
