...
--
-- Name: mode_bool_state(integer[], text, boolean); Type: FUNCTION; Schema: public; Owner: shamsutdinov_lr
--

CREATE OR REPLACE FUNCTION public.mode_bool_state(integer[], text, boolean) RETURNS integer[]
    LANGUAGE sql
    AS $_$
SELECT CASE 1 > 2
WHEN TRUE THEN
...
ALTER FUNCTION public.mode_bool_state(integer[], text, boolean) OWNER TO shamsutdinov_lr;
...
--
-- Name: mode11(boolean, integer, text, text, boolean); Type: AGGREGATE; Schema: public; Owner: shamsutdinov_lr
--
