...
ALTER TABLE default.t2_1 ADD INDEX ind1 col1 > 0 TYPE bloom_filter GRANULARITY 1;
...
ALTER TABLE default.t2_2 ADD INDEX ind3 col1 > col2 TYPE bloom_filter GRANULARITY 1;
