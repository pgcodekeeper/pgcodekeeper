...
CREATE TABLE [dbo].[t1](
    [col1_1] [bigint] NULL,
    [col1_2] [bigInt] NOT NULL,
    [col2_1] [uniqueidentifier] NOT NULL,
    [col2_2] [uniqueidentifier] ROWGUIDCOL NOT NULL,
    [col3_1] [int] NOT NULL IDENTITY (1,1),
    [col3_2] [int] NOT NULL IDENTITY (1,1) not for replication,
    [col4_1] int NULL,
    [col4_2] int NULL SPARSE,
    [a_1] [int] NULL,
	[b_1] [int] NULL,
	[c_1] AS ([a_1]+[b_1]),
	[a_2] [int] NULL,
	[b_2] [int] NULL,
	[c_2] AS ([a_2]+[b_2]) persisted
) ON [test1fg]
GO
