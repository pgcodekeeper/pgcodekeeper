...
ALTER TABLE [dbo].[t1]
    ADD CONSTRAINT [UK_t1] UNIQUE ([col1]) ON [PRIMARY]
GO
...
WITH (SYSTEM_VERSIONING = ON (HISTORY_TABLE = [dbo].[TemporalHistoryFor_t3], HISTORY_RETENTION_PERIOD = 3 WEEK))
GO
...
WITH (SYSTEM_VERSIONING = ON (HISTORY_TABLE = [dbo].[TemporalHistoryFor_t4]))
GO
