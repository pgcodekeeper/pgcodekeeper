...
ALTER TABLE public.t1 DISABLE RULE rule_enable;
ALTER TABLE public.t1 DISABLE RULE rule_enable_replica;
ALTER TABLE public.t1 DISABLE RULE rule_enable_always;
