...
class MsDiffTest {
    ...
    @ValueSource(strings = {
            ...
            // Tests scenario where MS COLUMN GENERATED option changed.
            "modify_ms_column_generated",
            ...
            // Test scenario when table columns were altered and dependent view was altered
