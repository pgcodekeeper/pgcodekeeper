...
private final Deque<String> _tags = new ArrayDeque<String>();
    ...
    */
    ...
    TXID_SNAPSHOT: [tT] [xX] [iI] [dD] UNDERLINE [sS] [nN] [aA] [pP] [sS] [hH] [oO] [tT];
    JSON : [jJ] [sS] [oO] [nN];
    ...
    ANYENAM : [aA] [nN] [yY] [eE] [nN] [aA] [mM];
    ANYRANGE : [aA] [nN] [yY] [rR] [aA] [nN] [gG] [eE]; 
    CSTRING : [cC] [sS] [tT] [rR] [iI] [nN] [gG];
    INTERNAL : [iI] [nN] [tT] [eE] [rR] [nN] [aA] [lL];
    LANGUAGE_HANDLER : [lL] [aA] [nN] [gG] [uU] [aA] [gG] [eE] UNDERLINE [hH] [aA] [nN] [dD] [lL] [eE] [rR];
    FWD_HANDLER : [fF] [wW] [dD] UNDERLINE [hH] [aA] [nN] [dD] [lL] [eE] [rR]; 
    INDEX_AM_HANDLER : [iI] [nN] [dD] [eE] [xX] UNDERLINE [aA] [mM] UNDERLINE [hH] [aA] [nN] [dD] [lL] [eE] [rR]; 
    TSM_HANDLER : [tT] [sS] [mM] UNDERLINE [hH] [aA] [nN] [dD] [lL] [eE] [rR]; 
    EVENT_TRIGGER : [eE] [vV] [eE] [nN] [tT] UNDERLINE [tT] [rR] [iI] [gG] [gG] [eE] [rR];
    PG_DDL_COMMAND : [pP] [gG] UNDERLINE [dD] [dD] [lL] UNDERLINE [cC] [oO] [mM] [mM] [aA] [nN] [dD];
    OPAQUE : [oO] [pP] [aA] [qQ] [uU] [eE];
    PG_LSN : [pP] [gG] UNDERLINE [lL] [sS] [nN];
    ABSTIME : [aA] [bB] [sS] [tT] [iI] [mM] [eE];
    RELTIME : [rR] [eE] [lL] [tT] [iI] [mM] [eE];
    TID : [tT] [iI] [dD];
    XID : [xX] [iI] [dD];
    CID : [cC] [iI] [dD];
    REGDICTIONARY : [rR] [eE] [gG] [dD] [iI] [cC] [tT] [iI] [oO] [nN] [aA] [rR] [yY];
    REGNAMESPACE : [rR] [eE] [gG] [nN] [aA] [mM] [eE] [sS] [pP] [aA] [cC] [eE];
    REGOPER : [rR] [eE] [gG] [oO] [pP] [eE] [rR]; 
    REGOPERATOR : [rR] [eE] [gG] [oO] [pP] [eE] [rR] [aA] [tT] [oO] [rR];
    REGPROC : [rR] [eE] [gG] [pP] [rR] [oO] [cC];
    REGPROCEDURE : [rR] [eE] [gG] [pP] [rR] [oO] [cC] [eE] [dD] [uU] [rR] [eE];
    REGROLE : [rR] [eE] [gG] [rR] [oO] [lL] [eE];
    REGTYPE : [rR] [eE] [gG] [tT] [yY] [pP] [eE];
    TINTERVAL : [tT] [iI] [nN] [tT] [eE] [rR] [vV] [aA] [lL];
    DATERANGE : [dD] [aA] [tT] [eE] [rR] [aA] [nN] [gG] [eE];
    NUMRANGE : [nN] [uU] [mM] [rR] [aA] [nN] [gG] [eE];
    INT4RANGE : [iI] [nN] [tT] '4' [rR] [aA] [nN] [gG] [eE];
    INT8RANGE : [iI] [nN] [tT] '8' [rR] [aA] [nN] [gG] [eE];
    TSRANGE : [tT] [sS] [rR] [aA] [nN] [gG] [eE];
    TSTZRANGE : [tT] [sS] [tT] [zZ] [rR] [aA] [nN] [gG] [eE];
