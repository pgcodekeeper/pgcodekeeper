...
public class JdbcType{
     ...
     */
    public JdbcType(long oid, String typeName, String typelem, long typarray, String parentSchema, String elemname) {
        this.oid = oid;
        this.parentSchema = parentSchema;
        this.isArrayType = typarray == 0L && !"0".equals(typelem);
