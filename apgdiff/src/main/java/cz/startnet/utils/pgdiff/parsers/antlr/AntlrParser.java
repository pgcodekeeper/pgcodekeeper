...
public class AntlrParser {
    ...
    public static void parseInputStream(InputStream inputStream, String charsetName,
            String parsedObjectName, final SQLParserBaseListener listener,
            IProgressMonitor mon, final int monitoringLevel) throws IOException, InterruptedException {
        final SQLParser parser = makeBasicParser(inputStream, charsetName, parsedObjectName);
