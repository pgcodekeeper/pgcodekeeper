...
public class CreateMsIndex extends ParserAbstract {
    ...
    public PgStatement getObject() {
        ...
        parseIndex(ctx.index_rest(), schemaName, tableName, ind, db);
    ...
    public static void parseIndex(Index_restContext rest,
        ...
        /*
        Column_name_listContext incl = sort.column_name_list();
        if (incl != null) {
            for (IdContext inclCol : incl.id()) {
                ind.addDep(new GenericColumn(schemaName, tableName, inclCol.getText(), DbObjType.COLUMN));
            }
        }
         */
