...
class TimestampTZPgDataTest extends AbstractPgTimeDateDataTest<TimestampTZPgData, ZonedDateTime> {
    ...
    public TimestampTZPgDataTest() {
        super(ZonedDateTime.parse("1970-01-01T00:00:00Z"),
                ZonedDateTime.parse("1970-01-01T08:00:00Z"),
                ZonedDateTime.parse("1970-01-01T08:00:00Z"));
    }

    @BeforeEach
    void setUp() {
        data = new TimestampTZPgData();
        setDefaultValues();
    }
    ...
    protected Stream<Arguments> generateGetStepFromStringTestData() {
        return Stream.of(Arguments.of(step, "PT8H"));
    }

    @Override
    protected Stream<Arguments> generateValueFromStringTestData() {
        return Stream.of(Arguments.of(start, "1970-01-01T00:00Z"));
    }
}
