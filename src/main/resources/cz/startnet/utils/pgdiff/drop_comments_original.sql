...
COMMENT ON TYPE typ_composite IS 'This composite type';

COMMENT ON COLUMN typ_composite."key" IS 'Type column of composite comment';
...
COMMENT ON DOMAIN dom IS 'Domain comment';
