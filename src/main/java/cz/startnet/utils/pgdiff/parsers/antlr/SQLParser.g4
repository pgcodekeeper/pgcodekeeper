...
alter_schema_statement
    : SCHEMA name=identifier (OWNER | RENAME) TO new_name=identifier
    ;
...
grant_statement
    ...
    | role_name+=identifier (COMMA role_name+=identifier)* TO role_name+=identifier(COMMA role_name+=identifier)* (WITH ADMIN OPTION)?)
    ;
