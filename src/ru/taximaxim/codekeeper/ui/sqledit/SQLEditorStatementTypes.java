...
public enum SQLEditorStatementTypes {
    ...
    PREDICATES("prefsPredicates", Messages.SQLEditorStatementTypes_predicates), //$NON-NLS-1$
    ...
    CONSTANTS("prefsConstants", Messages.SQLEditorStatementTypes_consts), //$NON-NLS-1$
    SINGLE_LINE_COMMENTS("prefsSingleLineComments", Messages.SQLEditorStatementTypes_single_comments), //$NON-NLS-1$
    GLOBAL_VARIABLES("prefsGlobalVariables", Messages.SQLEditorStatementTypes_global_vars), //$NON-NLS-1$
