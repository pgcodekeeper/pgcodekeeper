...
public class DiffPartDescr {
        ...
        btnGetLatest.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                TextDialog dialog = new TextDialog(
                        shell, TextDialog.INFORMATION, "Diff script",
        ...
        diffTree.viewer.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                ...
                if(el.getSide() == DiffSide.LEFT || el.getSide() == DiffSide.BOTH) {
                    txtDb.setText(el.getPgStatement(dbSource.getDbObject()).getCreationSQL());
                } else {
                    txtDb.setText("");
                }
                if(el.getSide() == DiffSide.RIGHT || el.getSide() == DiffSide.BOTH) {
                    txtSvn.setText(el.getPgStatement(dbTarget.getDbObject()).getCreationSQL());
                } else {
                    txtSvn.setText("");
                }
            }
    ...
    public static void openNew(String projectPath, EPartService partService,
        ...
        for(MPart existingPart : model.findElements(app, UIConsts.PART_DIFF,
                MPart.class, null)) {
            if(projectPath.equals(existingPart.getPersistedState().get(UIConsts.PART_DIFF_ID))) {
